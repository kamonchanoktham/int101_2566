...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
       System.out.println("Your BMI : " + work03.MyUtil.calculateBMI(45, 1.62));
       System.out.println("Average is : " + work03.MyUtil.average(4, 5, 6));
   }
   ...
   static void work04UseOfObjectClass() {
      ...
      */
      Person Karn = new Person(1);
      BankAccount account1 = new BankAccount(1,Karn);
      
      Person Yok = new Person(2);
      BankAccount account2 = new BankAccount(2,Yok);
      ...
      account2.transfer(200, account1);
       ...
       System.out.println(Yok.toString());
